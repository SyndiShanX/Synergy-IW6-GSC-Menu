 ...
 * Script: character\character_us_rangers_assault_a_desert.gsc
***************************************************************/

main() {
  self setModel("body_us_rangers_assault_a_desert");
...
precache() {
  precachemodel("body_us_rangers_assault_a_desert");
